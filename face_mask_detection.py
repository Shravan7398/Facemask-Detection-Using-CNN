...
maskClassifier = load_model('..location to save model/maskclassifier.model')  # Mask classifier

while True:

    _, frame = cap.read()  # Reading frames from video source
    ...
    for (x, y, h, w) in faces:
        ...
        (label, color, prob) = ('Mask', (0, 255, 0), withmask * 100.0) if withmask > withoutmask else (
            'No mask', (0, 0, 255), withoutmask * 100.0)
